    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repost_type', models.CharField(blank=True, choices=[('repost', 'Repost'), ('quote', 'Quote')], max_length=10, null=True)),
                ...
                ('trending_vector', django.contrib.postgres.search.SearchVectorField(blank=True, null=True)),
